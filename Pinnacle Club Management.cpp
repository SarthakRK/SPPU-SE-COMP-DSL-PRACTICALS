...
Similarly one may cancel the membership of a club.
First node is reserved for the president of the club and the last node is reserved for the secretary of the club.

Write C++ program to maintain club members information using singly linked lists.
